    ...
    <div className="flex min-h-screen bg-[#f0f4f8]">
      ...
      <aside className="w-64 bg-[#1D3557] text-white flex flex-col justify-between">
        <div>
          ...
          <nav className="flex flex-col gap-2 p-4">
            <SidebarItem icon={<FaPlus />} label="Report Issue" />
            <SidebarItem icon={<FaClipboardList />} label="My Issues (List)" />
            <SidebarItem icon={<FaMapMarkerAlt />} label="My Issues (Map)" />
            <SidebarItem icon={<FaChartPie />} label="Proposal Voting" />
            <SidebarItem icon={<FaComments />} label="Chat" />
            <SidebarItem icon={<FaChartPie />} label="Summary" />
            <SidebarItem icon={<FaMapMarkerAlt />} label="AR Report" />
          </nav>
        </div>
      ...
      <main className="flex-1 p-6">
        <header className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#1D3557]">Welcome back, Saad Shahid</h1>
            <p className="text-sm text-gray-600">Here’s a snapshot of your activity</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-sm font-semibold text-[#1D3557]">Saad Shahid</p>
